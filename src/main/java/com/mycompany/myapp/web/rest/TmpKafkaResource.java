...
@RestController
@RequestMapping("/api/tmp-kafka")
public class TmpKafkaResource {

    private static final String PRODUCER_BINDING_NAME = "binding-out-0";

    private static final Logger LOG = LoggerFactory.getLogger(TmpKafkaResource.class);
    private final KafkaConsumer kafkaConsumer;
    private final StreamBridge streamBridge;

    public TmpKafkaResource(StreamBridge streamBridge, KafkaConsumer kafkaConsumer) {
